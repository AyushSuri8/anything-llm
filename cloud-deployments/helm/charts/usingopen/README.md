...
![UsingOpen](https://raw.githubusercontent.com/AyushSuri8/anything-llm/refs/heads/usingopen-rebrand/images/wordmark.png)

[UsingOpen](https://github.com/AyushSuri8/anything-llm)
...
```
helm install my-usingopen ./usingopen -f values-secret.yaml
```
