...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "UsingOpen kan arbejde med mange LLM-udbydere. Dette vil være den tjeneste, der håndterer chat.",
    },
    userSetup: {
    ...
    survey: {
      title: "Velkommen til UsingOpen",
      description:
        "Hjælp os med at gøre UsingOpen tilpasset dine behov. Valgfrit.",
      email: "Hvad er din e-mail?",
      useCase: "Hvad vil du bruge UsingOpen til?",
      useCaseWork: "Til arbejde",
      useCasePersonal: "Til personligt brug",
      useCaseOther: "Andet",
      comment: "Hvordan hørte du om UsingOpen?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Aktiver ubegrænsede værktøjer og reducer brugen af cut-tokens med op til 80 % pr. forespørgsel – UsingOpen vælger automatisk de relevante færdigheder til hver forespørgsel.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  api: {
    title: "API-nøgler",
    description:
      "API-nøgler giver indehaveren mulighed for programmatisk at få adgang til og administrere denne UsingOpen-instans.",
    ...
    modal: {
      ...
      helper:
        "Når API-nøglen er oprettet, kan den bruges til programmatisk at få adgang til og konfigurere denne UsingOpen-instans.",
      name: {
        label: "Navn",
  ...
  llm: {
    title: "LLM-præference",
    description:
      "Disse er legitimationsoplysningerne og indstillingerne for din foretrukne LLM chat- og indlejringsudbyder. Det er vigtigt, at disse nøgler er opdaterede og korrekte, ellers vil UsingOpen ikke fungere korrekt.",
  ...
  transcription: {
    ...
    "warn-start":
      "Brug af den lokale whisper-model på maskiner med begrænset RAM eller CPU kan få UsingOpen til at gå i stå under behandling af mediefiler.",
  ...
  embedding: {
    ...
    "desc-end":
      "Indlejring er processen med at omdanne tekst til vektorer. Disse legitimationsoplysninger er nødvendige for at omdanne dine filer og prompts til et format, som UsingOpen kan bruge til behandling.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Disse er legitimationsoplysningerne og indstillingerne for, hvordan din UsingOpen-instans vil fungere. Det er vigtigt, at disse nøgler er opdaterede og korrekte.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dette er din konfiguration for, hvordan tilsluttede tredjepartsudbydere og UsingOpen håndterer dine data.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Disse filer vil blive uploadet til dokumentbehandleren, der kører på denne UsingOpen-instans. Filene sendes ikke eller deles med en tredjepart.",
    },
    pinning: {
      what_pinning: "Hvad er dokumentfastlåsning?",
      pin_explained_block1:
        "Når du <b>fastlåser</b> et dokument i UsingOpen, vil vi indsætte hele dokumentets indhold i din prompt-vindue, så din LLM kan forstå det fuldt ud.",
      pin_explained_block2:
        "Dette fungerer bedst med <b>store kontekstmodeller</b> eller små filer, der er kritiske for dens vidensbase.",
      pin_explained_block3:
        "Hvis du ikke får de svar, du ønsker fra UsingOpen som standard, er fastlåsning en fremragende måde at få svar af højere kvalitet med et enkelt klik.",
      accept: "Okay, jeg har forstået",
    },
    watching: {
      what_watching: "Hvad gør det at overvåge et dokument?",
      watch_explained_block1:
        "Når du <b>overvåger</b> et dokument i UsingOpen, vil vi <i>automatisk</i> synkronisere dokumentets indhold fra dets oprindelige kilde med jævne mellemrum. Dette vil automatisk opdatere indholdet i alle arbejdsområder, hvor denne fil administreres.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Hukommelse",
        placeholder:
          "f.eks. Brugerens navn er Joe, brugeren arbejder med UsingOpen, osv.",
        create: "Opret",
        save: "Gem",
        cancel: "Annullér",
      },
  ...
  customization: {
    interface: {
      ...
      description: "Konfigurer dine præferencer for UsingOpen.",
    },
    branding: {
      title: 'Brandstrategi og "white label"-løsninger',
      description: "Mærk din UsingOpen-instans med dit eget brand.",
    },
    chat: {
      title: "Chat",
      description: "Angiv dine præferencer for chat med UsingOpen.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Visningssprog",
        description:
          "Vælg det foretrukne sprog til at vise UsingOpen's brugergrænseflade i – når oversættelser er tilgængelige.",
      },
      logo: {
        title: "Brand Logo",
        description:
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Beskyt din UsingOpen-instans med en adgangskode. Hvis du glemmer den, findes der ingen genoprettelsesmetode, så sørg for at gemme denne adgangskode.",
  ...
  telegram: {
    title: "Telegram-bot",
    description:
      "Forbind dit UsingOpen-instans med Telegram, så du kan kommunikere med dine arbejdsområder fra enhver enhed.",
    setup: {
      step1: {
