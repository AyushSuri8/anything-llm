...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "UsingOpen puede funcionar con muchos proveedores de LLM. Este será el servicio que gestionará el chat.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bienvenido a UsingOpen",
      description:
        "Ayúdanos a hacer que UsingOpen se adapte a tus necesidades. Opcional.",
      email: "¿Cuál es tu correo electrónico?",
      useCase: "¿Para qué usarás UsingOpen?",
      useCaseWork: "Para el trabajo",
      useCasePersonal: "Para uso personal",
      useCaseOther: "Otro",
      comment: "¿Cómo te enteraste de UsingOpen?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      heading: "Explícame",
      body: "los beneficios de UsingOpen",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Permite el uso ilimitado de herramientas y reduce el consumo de tokens hasta en un 80% por consulta: UsingOpen selecciona automáticamente las habilidades adecuadas para cada solicitud.",
        "max-tools": {
  ...
  customization: {
    interface: {
      ...
      description:
        "Establece tus preferencias de la interfaz de usuario para UsingOpen.",
    },
    branding: {
    ...
    chat: {
      title: "Chat",
      description: "Establece tus preferencias de chat para UsingOpen.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selecciona el idioma preferido para renderizar la interfaz de usuario de UsingOpen, cuando las traducciones estén disponibles.",
      },
      logo: {
  ...
  api: {
    title: "Claves de API",
    description:
      "Las claves de API permiten al titular acceder y administrar programáticamente esta instancia de UsingOpen.",
    ...
    modal: {
      ...
      helper:
        "Una vez creada, la clave API se puede usar para acceder y configurar esta instancia de UsingOpen mediante programación.",
      name: {
        label: "Nombre",
  ...
  llm: {
    title: "Preferencia de LLM",
    description:
      "Estas son las credenciales y la configuración de tu proveedor preferido de chat e incrustación de LLM. Es importante que estas claves estén actualizadas y sean correctas, de lo contrario, UsingOpen no funcionará correctamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "El uso del modelo local de Whisper en máquinas con RAM o CPU limitadas puede detener UsingOpen al procesar archivos multimedia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "La incrustación es el proceso de convertir texto en vectores. Estas credenciales son necesarias para convertir tus archivos y prompts en un formato que UsingOpen pueda usar para procesar.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Estas son las credenciales y la configuración de cómo funcionará tu instancia de UsingOpen. Es importante que estas claves estén actualizadas y sean correctas.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Esta es tu configuración sobre cómo los proveedores de terceros conectados y UsingOpen manejan tus datos.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Estos archivos se subirán al procesador de documentos que se ejecuta en esta instancia de UsingOpen. Estos archivos no se envían ni se comparten con terceros.",
    },
    pinning: {
      what_pinning: "¿Qué es fijar documentos?",
      pin_explained_block1:
        "Cuando <b>fijas</b> un documento en UsingOpen, inyectaremos todo el contenido del documento en tu ventana de prompt para que tu LLM lo comprenda por completo.",
      ...
      pin_explained_block3:
        "Si no obtienes las respuestas que deseas de UsingOpen por defecto, fijar es una excelente manera de obtener respuestas de mayor calidad con un clic.",
      accept: "Ok, entendido",
    },
    watching: {
      what_watching: "¿Qué hace observar un documento?",
      watch_explained_block1:
        "Cuando <b>observas</b> un documento en UsingOpen, sincronizaremos <i>automáticamente</i> el contenido de tu documento desde su fuente original a intervalos regulares. Esto actualizará automáticamente el contenido en cada espacio de trabajo donde se gestione este archivo.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memoria",
        placeholder:
          "Por ejemplo, el nombre del usuario es Joe, el usuario trabaja en UsingOpen, etc.",
        create: "Crear",
        save: "Guardar",
        cancel: "Cancelar",
      },
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protege tu instancia de UsingOpen con una contraseña. Si la olvidas, no hay método de recuperación, así que asegúrate de guardar esta contraseña.",
  ...
  telegram: {
    ...
    description:
      "Conecte su instancia de UsingOpen a Telegram para poder conversar con sus espacios de trabajo desde cualquier dispositivo.",
    setup: {
      step1: {
