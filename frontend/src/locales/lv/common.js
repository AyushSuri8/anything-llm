...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "UsingOpen var strādāt ar daudziem LLM pakalpojumu sniedzējiem. Šis būs pakalpojums, kas apstrādās sarunas.",
    },
    userSetup: {
    ...
    survey: {
      title: "Laipni lūgti UsingOpen",
      description:
        "Palīdziet mums veidot UsingOpen atbilstoši jūsu vajadzībām. Neobligāti.",
      email: "Kāds ir jūsu e-pasts?",
      useCase: "Kam izmantosiet UsingOpen?",
      useCaseWork: "Darbam",
      useCasePersonal: "Personīgai lietošanai",
      useCaseOther: "Citam nolūkam",
      comment: "Kā jūs uzzinājāt par UsingOpen?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          'Ievērojiet neierobežotu rīku un "cut token" izmantošanas samazinājumu līdz 80% uz katru pieprasījumu – UsingOpen automātiski izvēlas piemērotākās prasmes katram pieprasījumam.',
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Iestatiet savas UI preferences UsingOpen.",
    },
    branding: {
      title: "Zīmolrade un identitāte",
      description:
        "Pielāgojiet savu UsingOpen instanci ar pielāgotu zīmolradi.",
    },
    chat: {
      title: "Saruna",
      description: "Iestatiet savas sarunas preferences UsingOpen.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Izvēlieties vēlamo valodu UsingOpen lietotāja saskarnei - kad pieejami tulkojumi.",
      },
      logo: {
  ...
  api: {
    title: "API atslēgas",
    description:
      "API atslēgas ļauj to īpašniekam programmatiski piekļūt un pārvaldīt šo UsingOpen instanci.",
    ...
    modal: {
      ...
      helper:
        "Pēc izveides API atslēgu var izmantot, lai programmatiski piekļūtu šai UsingOpen instancei un to konfigurētu.",
      name: {
        label: "Nosaukums",
  ...
  llm: {
    title: "LLM preferences",
    description:
      "Šie ir akreditācijas dati un iestatījumi jūsu vēlamajam LLM čata un iegulšanas pakalpojuma sniedzējam. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas, pretējā gadījumā UsingOpen nedarbosies pareizi.",
  ...
  transcription: {
    ...
    "warn-start":
      "Izmantojot lokālo whisper modeli iekārtās ar ierobežotu RAM vai CPU var apstādināt UsingOpen, apstrādājot multivides failus.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Iegulšana ir process, ar kuru teksts tiek pārveidots vektoros. Šie akreditācijas dati ir nepieciešami, lai pārveidotu jūsu failus un vaicājumus formātā, kuru UsingOpen var izmantot apstrādei.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Šie ir akreditācijas dati un iestatījumi tam, kā darbosies jūsu UsingOpen instance. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Šī ir jūsu konfigurācija tam, kā savienotie trešo pušu pakalpojumu sniedzēji un UsingOpen apstrādā jūsu datus.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Šie faili tiks augšupielādēti dokumentu apstrādātājā, kas darbojas šajā UsingOpen instancē. Šie faili netiek nosūtīti vai kopīgoti ar trešo pusi.",
    },
    pinning: {
      what_pinning: "Kas ir dokumentu piespraušana?",
      pin_explained_block1:
        "Kad jūs <b>piespraudiet</b> dokumentu UsingOpen, mēs ievietosim visu dokumenta saturu jūsu uzvednes logā, lai jūsu LLM to pilnībā saprastu.",
      pin_explained_block2:
        "Tas vislabāk darbojas ar <b>liela konteksta modeļiem</b> vai maziem failiem, kas ir kritiski tā zināšanu bāzei.",
      pin_explained_block3:
        "Ja jūs nesaņemat vēlamās atbildes no UsingOpen pēc noklusējuma, tad piespraušana ir lielisks veids, kā iegūt kvalitatīvākas atbildes ar vienu klikšķi.",
      accept: "Labi, sapratu",
    },
    watching: {
      what_watching: "Ko dara dokumenta novērošana?",
      watch_explained_block1:
        "Kad jūs <b>novērojat</b> dokumentu UsingOpen, mēs <i>automātiski</i> sinhronizēsim jūsu dokumenta saturu no tā sākotnējā avota regulāros intervālos. Tas automātiski atjauninās saturu katrā darba vietā, kur šis fails tiek pārvaldīts.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Aizsargājiet savu UsingOpen instanci ar paroli. Ja aizmirsīsiet šo paroli, nav atgūšanas metodes, tāpēc pārliecinieties, ka saglabājat šo paroli.",
  ...
  telegram: {
    title: "Telegram bot",
    description:
      "Iespējiet savu UsingOpen instanci, lai varētu tikt savienots ar Telegram, un tāpēc varēsat runāt ar saviem darba grupām no jebkura ierīces.",
    setup: {
      step1: {
