...
const SHOW_METRICS_KEY = "usingopen_show_chat_metrics";
const SHOW_METRICS_EVENT = "usingopen_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `usingopen_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `usingopen_show_chat_metrics` key
 * @returns {void}
 */
