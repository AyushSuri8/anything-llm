...
export const AUTH_USER = "usingopen_user";
export const AUTH_TOKEN = "usingopen_authToken";
export const AUTH_TIMESTAMP = "usingopen_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "usingopen_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "usingopen_pinned_document_alert";
export const SEEN_WATCH_ALERT = "usingopen_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "usingopen_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "usingopen_user_prompt_input_map";
export const PENDING_HOME_MESSAGE = "usingopen_pending_home_message";

export const APPEARANCE_SETTINGS = "usingopen_appearance_settings";
