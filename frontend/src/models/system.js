...
const System = {
  cacheKeys: {
    footerIcons: "usingopen_footer_links",
    supportEmail: "usingopen_support_email",
    customAppName: "usingopen_custom_app_name",
    canViewChatHistory: "usingopen_can_view_chat_history",
    deploymentVersion: "usingopen_deployment_version",
  },
  ping: async function () {
