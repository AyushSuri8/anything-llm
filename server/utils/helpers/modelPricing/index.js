...
/**
 * UsingOpen provider slug -> models.dev provider id.
...
class ModelPricing {
  ...
  /**
   * @param {string|null} providerSlug - UsingOpen provider slug
 ...
 * @param {Object} opts
 * @param {string|null} opts.provider - UsingOpen provider slug
