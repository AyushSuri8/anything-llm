...
// This keeps accidental misconfigurations of UsingOpen that leave the collector port open from
...
class CommunicationKey {
  ...
  #generate() {
    ...
    this.log(
      "RSA key pair generated for signed payloads within UsingOpen services."
    );
  }
