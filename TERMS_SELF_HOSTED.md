# UsingOpen Self-Hosted: Data Privacy & Terms of Service

This document outlines the privacy standards, data handling procedures, and licensing terms for the self-hosted version of UsingOpen, developed by Mintplex Labs Inc.

## 1. Data Sovereignty & Local-First Architecture
UsingOpen is designed as a **local-first** application. When utilizing the self-hosted version (Docker, Desktop, or Source):
...
* **License:** The UsingOpen core is provided under the **MIT License**.
